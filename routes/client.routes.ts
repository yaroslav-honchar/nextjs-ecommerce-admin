export const ClientRoutes = {
  ...
  subCategories: (storeId: string): string => `/${storeId}/sub-categories`,
  subCategoryEdit: (storeId: string, categoryId: string = "new"): string => `/${storeId}/sub-categories/${categoryId}`,
